...
module.exports = async function (dave, chatId, city) {
    try {
        ...
        await dave.sendMessage(chatId, { text: weatherText });
    } catch (error) {
        console.error('Error fetching weather:', error);
        await dave.sendMessage(chatId, { text: 'Sorry, I could not fetch the weather right now.' });
    }
};
