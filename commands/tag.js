...
async function tagCommand(dave, chatId, senderId, messageText, replyMessage) {
    ...
    if (!isSenderAdmin) {
        ...
        if (fs.existsSync(stickerPath)) {
            ...
            await dave.sendMessage(chatId, { sticker: stickerBuffer });
        }
        return;
    }
    ...
    if (replyMessage) {
        ...
        if (Object.keys(messageContent).length > 0) {
            await dave.sendMessage(chatId, messageContent);
        }
    } else {
