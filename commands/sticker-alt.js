...
async function stickerCommand(dave, chatId, message) {
    try {
        const quotedMsg = message.message.extendedTextMessage?.contextInfo?.quotedMessage;
        if (!quotedMsg) {
            await dave.sendMessage(chatId, { text: 'Please reply to an image or video!' });
            return;
        }
        ...
        await dave.sendMessage(chatId, { text: 'Failed to create sticker!' });
    }
}
