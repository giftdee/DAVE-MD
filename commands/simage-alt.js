...
async function simageCommand(dave, quotedMessage, chatId) {
    try {
        if (!quotedMessage?.stickerMessage) {
            await dave.sendMessage(chatId, { text: 'Please reply to a sticker!' });
            return;
        }
        ...
        await dave.sendMessage(chatId, { text: 'Failed to convert sticker to image!' });
    }
}
